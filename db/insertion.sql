...
INSERT INTO Department(name, description, director, internal_departments, head_department) VALUES
    ('Аналитика', 'Аналитика всего', 3, ['Системная аналитика', 'Большие данные'], 'Системная аналитика'),
    ('Разработка', 'Разработка ПО', 1, ['Python разработка', 'Java разработка', 'JavaScript разработка'], 'Python разработка');

INSERT INTO Position_(name, description, duties) VALUES
    ('Разработчик', 'Разрабатывает ПО', 'Раработка и отладка ПО'),
    ('Главный разработчик', 'Опытный и хорошо разрабатывает ПО', 'Разработка, отладка и проверка ПО'),
    ('Аналитик', 'Ищет закономерности, анализирует', 'Построение гипотез, их анализ'),
    ('Главный аналитик', 'Ищет закономерности, анализирует', 'Построение гипотез, их аналих. Проверка других аналитиков');
...
INSERT INTO EmployeeInfo(employee_id, position_id, department_id, start_date, end_date) VALUES
    ...
    (2, 1, 2, '2022-10-10 6:00:00', '2022-12-01 5:59:59'),
    (3, 1, 2, '2022-10-10 6:00:00', '2024-01-10 5:59:59'),
    (4, 3, 1, '2021-09-20 6:00:00', '2023-09-09 5:59:59'),
    (4, 4, 1, '2023-09-09 6:00:00', NULL),
    (5, 4, 1, '2023-10-09 6:00:00', NULL),
    (6, 1, 2, '2022-10-10 6:00:00', '2023-09-09 5:59:59'),
